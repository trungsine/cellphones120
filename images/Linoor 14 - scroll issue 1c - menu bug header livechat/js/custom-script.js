...
var today = new Date();
var year = new Intl.DateTimeFormat('ja-JP', { year: 'numeric' }).format(today);
var month = today.toLocaleString('ja-JP', { month: 'long' }); // English (US)
var day = new Intl.DateTimeFormat('ja-JP', { day: 'numeric' }).format(today);
var weekday = today.toLocaleString('ja-JP', { weekday: 'long' }); // English (US)
var time = today.toLocaleString('ja-JP', { hour: '2-digit', minute: '2-digit', second: '2-digit', millisecond: '3-digit' });
